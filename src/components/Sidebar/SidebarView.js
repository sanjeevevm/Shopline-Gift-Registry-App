...
const structure = [
  ...
  { id: 1, label: 'Settings', link: '/app/typography', icon: <TypographyIcon /> },
  { id: 2, label: 'Page Design', link: '/app/tables', icon: <TableIcon /> },
  { id: 3, label: 'Language', link: '/app/notifications', icon: <NotificationsIcon />},
  { id: 4, label: 'Manual Instruction', link: '/app/notifications', icon: <NotificationsIcon />},
  { id: 5, label: 'Installation Instruction', link: '/app/notifications', icon: <NotificationsIcon />},
  /*{
    id: 4,
    label: 'UI Elements',
    link: '/app/ui',
